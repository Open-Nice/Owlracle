    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger asChild>
        <div className="tooltip">
          ...
          <span className="tooltiptext tooltip-top tooltip-upload shadow border bg-popover text-popover-foreground"><div>Teach Athena! <span style={{ fontSize: '25px' }}>😍</span></div></span>
        </div> 
